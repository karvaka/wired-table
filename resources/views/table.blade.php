    ...
    @if($enableSearch)
        <div class="relative md:w-1/3 mb-4">
            <input type="search"
                   ...
                   class="w-full pl-10 pr-4 py-2 border-0 rounded-lg shadow text-gray-600 text-sm font-medium"
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end space-x-3">
                                        ...
                                        <button class="cursor-pointer text-red-500 hover:text-red-600 focus:outline-none">
